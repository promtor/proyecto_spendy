<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <fieldset>
            ...
            <button
                onclick="callApi('/api/usuarios','POST',{nombre: regNombre.value, correo: regCorreo.value, password: regPassword.value})">Registrar</button>
        </fieldset>
        ...
        <fieldset>
            ...
            <button
                onclick="callApi('/api/login','POST',{correo: loginCorreo.value, password: loginPassword.value})">Login</button>
        </fieldset>
        ...
        <fieldset>
            ...
            usuarioId: parseInt(gastoUsuario.value), fecha: gastoFecha.value,
            importe: parseFloat(gastoImporte.value), categoriaId: parseInt(gastoCat.value),
            descripcion: gastoDesc.value, latitud: parseFloat(gastoLat.value), longitud: parseFloat(gastoLon.value)
        })">Añadir Gasto</button>
        </fieldset>
        ...
        <!-- Registrar Ingreso -->
        <fieldset>
            <legend>Registrar Ingreso</n atro>
            ...
            usuarioId: parseInt(ingUsuario.value), fecha: ingFecha.value,
            importe: parseFloat(ingImporte.value), descripcion: ingDesc.value,
        ...
        <fieldset>
            ...
            gastoId: parseInt(tGastoId.value), imagenPath: tImagen.value, textoOCR: tTexto.value
        })">Subir Ticket</button>
            ...
            <button onclick="callApi('/api/tickets/'+tIdEdit.value,'PUT',{textoOCR: tNuevoOCR.value})">Editar
                OCR</button>
        ...
        <fieldset>
            ...
            <button
                onclick="callApi('/api/limites','POST',{usuarioId: parseInt(limUsuario.value), limiteMensual: parseFloat(limValor.value)})">Establecer
                Límite</button>
        ...
        <fieldset>
            ...
            <button
                onclick="callApi('/api/gastos/compartir','POST',{gastoId: parseInt(compGastoId.value), usuarios: JSON.parse(compUsuarios.value)})">Compartir</button>
        </fieldset>
        ...
        <fieldset>
            ...
            <button
                onclick="callApi('/api/configuracion','PUT',{usuarioId: parseInt(cfgUsuario.value), tema: cfgTema.value})">Guardar</button>
        </fieldset>
    </body>
